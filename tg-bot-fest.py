...
def welcome_new_members(message):
    ...
    bot.send_message(message.chat.id,
                     ...
                     "Прежде чем начать квест, ознакомьтесь со вступительной информацией.\n⬇️\n\n"
                     ...
                     "Мне всё понятно:", reply_markup=keyboard)
...
def start_new_game(message):
    bot.send_message(message.chat.id,"Царь написал вам сообщение в Telegram о том, что ему необходимы данные одного сотрудника. К сожалению, hr-менеджеры, окаянные, потеряли все его документы. Теперь, это дело ложиться на ваши плечи. "
                     ...
                     "Ваша задача - восстановить данные этого сотрудника. Используйте /todolist, чтобы увидеть свой прогресс и список данных, которые необходимо восстановить.\n"
